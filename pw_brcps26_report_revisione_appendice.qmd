...
In termini applicativi, ciò significa che calcolare la frazione attribuibile separatamente nelle diverse unità territoriali e aggregare successivamente i risultati non equivale ad applicare direttamente la funzione al differenziale medio di esposizione. A parità di criteri di ponderazione, quest'ultima procedura restituisce un valore maggiore o uguale a quello ottenuto mediante il calcolo sezionale.

Nella presente analisi, la media pertinente non è una semplice media aritmetica tra le sezioni censuarie. Il contributo di ciascuna sezione alla frazione attribuibile regionale è proporzionale al numero di decessi attesi nella stessa sezione, che dipende sia dalla popolazione residente di età pari o superiore a 30 anni sia dal corrispondente tasso provinciale di mortalità basale. Le sezioni nelle quali è atteso un numero maggiore di decessi incidono quindi maggiormente sul risultato regionale. Tale ponderazione non costituisce una scelta statistica aggiuntiva, ma deriva direttamente dalla definizione della frazione attribuibile regionale come rapporto tra il totale dei casi attribuibili e il totale dei decessi attesi.
