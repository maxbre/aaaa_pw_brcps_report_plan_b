...
Dal punto di vista dell'intrepretazione epidemiologica la stima puntale ottenuta dalla valutazione di impatto sanitario rappresenta il numero di *casi/anno teorici (decessi evitabili)* nell'eventualità per cui tutte le sezioni censuarie del Veneto siano esposte ad un livello di concentrazione ambientale di $NO_2 \leq 10\ \mu g~m^{-3}$, che rappresenta la soglia OMS stabilita dalle attuali evidenze scientifiche per escludere significativi (misurabili) effetti sanitari.
