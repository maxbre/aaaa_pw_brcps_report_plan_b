...
| Metrica | Bootstrap Semplice 2025 | Boostrap Spazio Temporale |
|:---|---:|---:|
| Mediana | 109.2 | 143.5 |
| SD | 21.5 | 36.1 |
| Q2.5 | 67.3 | 83.1 |
...
Parallelamente, andrà valutata l'estensione del disegno verso un framework di *inferenza causale spaziale* (*spatial causal inference*) [@akbari_sp_inf:2023], in grado di verificare l'eventuale violazione dell'assunzione *Stable Unit Treatment Value Assumption* (SUTVA) dovuta all'interazione tra sezioni censuarie adiacenti - ipotesi implicitamente assunta, ma non formalmente verificata, nell'approccio ecologico qui adottato. Si tratta in particolare di una violazione riconducibile al fatto che l'esito potenziale di ciascuna sezione censuaria non risulta indipendente dal livello di esposizione delle sezioni adiacenti, venendo meno l'ipotesi di assenza di interferenza tra unità vicine, per via della natura diffusiva del $NO_2$ nell'aria ambiente (*spillover* spaziale).
