...
- *mortalità basale*: l'impiego di tassi grezzi provinciali per l'intera popolazione 30+ non descrive completamente la diversa composizione per età delle sezioni censuarie e può produrre una classificazione imperfetta del rischio basale;
...
- *propagazione incompleta dell'incertezza*: nella simulazione 2025 viene considerata soltanto l'incertezza del $RR$. Non sono propagate le incertezze relative alle concentrazioni modellate, ai tassi di mortalità, alla popolazione e alla funzione concentrazione-risposta;
...
Un primo sviluppo dovrebbe riguardare la *propagazione integrata dell'incertezza*. Oltre al $RR$, potrebbero essere incluse l'incertezza delle concentrazioni modellate, dei tassi epidemiologici di base e delle stime demografiche sezionali. In particolare, l'errore delle concentrazioni potrebbe essere caratterizzato attraverso il confronto tra le stime modellistiche e le misure delle stazioni di monitoraggio, propagando residui dotati di una struttura spaziale. I tassi di mortalità potrebbero invece essere stratificati per classi d'età e stabilizzati nelle piccole aree mediante modelli gerarchici o tecniche di *Empirical Bayes smoothing* [@blangiardo_cameletti:2015].
