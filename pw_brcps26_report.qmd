...
*sviluppo contenuti per punti*

- unità di analisi, sezione censuaria ISTAT 2021, statistiche descrittive,  quantee quanto popolate, ripartizione per età, estensione e densità mediana sezione istat tipo

- mappa distribuzione popolazione 30+ sezioni censuarie RV, mappa di tipo demografico attuariale, 2021

- NO2 boxplot e mappe di concentrazione, trend temporale, mann-kendall + sen's slope, strtificazione boxplot per provincia e target OMS 10 ug/m3 come target di valutazione di impatto sanitario, mappa esposizione cuulativa stratificata per provincia, esposizione media pesata come info generale e stratificata per provincia

- mappa intersezione concentrazioni ambientali e sezioni censuarie, rappresenta la mappa di esposizione della popolazione alle concentrazioni ambientali di NO"

- VIS risultati stima puntuale casi attribuibili

- Bootstrapping intervallo di confidenza stima puntuale VIS

----

per Test di Mann-Kendall e stima della pendenza di Sen (MK and sens'slope) per trend ambientale a livello comunale fare la seguente precisazione.... rimodulare dove serve....
...
La presente Appendice riprende ed espande la nota *[1]* riportata nel testo al paragrafo -@sec-methods [Materiali e metodi](#sec-methods), fornendo un inquadramento relativamente alle caratteristiche della funzione di stima dei casi attribuibili $AC$, e conseguentemente della frazione attribuibile $AF$).
